...
(* A number is at most once in a given row and in a given column *)
let row var =
...
(* A number has to be somewhere in a row*)
...
(* There is at most one number in a given position *)
